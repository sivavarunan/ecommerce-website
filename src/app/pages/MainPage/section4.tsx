...
const Section4 = () => {
  ...
  return (
    <div className="dark:bg-gradient-to-t from-slate-900 via-slate-800 to-slate-800 text-white py-16 px-8 h-screen flex items-center">
      <div className="max-w-6xl mx-auto flex flex-col-reverse lg:flex-row items-center lg:items-start justify-between space-y-12 lg:space-y-0 lg:space-x-12">
        ...
        >
          {/* Title */}
          <div>
            <h1 className="text-5xl font-bold font-sans text-black dark:text-white tracking-tight">
              About Us
            </h1>
          </div>
